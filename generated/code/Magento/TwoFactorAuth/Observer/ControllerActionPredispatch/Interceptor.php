...
class Interceptor extends \Magento\TwoFactorAuth\Observer\ControllerActionPredispatch implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\TwoFactorAuth\Api\TfaInterface $tfa, \Magento\TwoFactorAuth\Api\TfaSessionInterface $tfaSession, \Magento\TwoFactorAuth\Api\UserConfigRequestManagerInterface $configRequestManager, \Magento\TwoFactorAuth\Model\UserConfig\HtmlAreaTokenVerifier $tokenManager, \Magento\Framework\App\ActionFlag $actionFlag, \Magento\Framework\UrlInterface $url, \Magento\Framework\AuthorizationInterface $authorization, \Magento\Authorization\Model\UserContextInterface $userContext, \Magento\AdminAdobeIms\Service\ImsConfig $adminAdobeImsConfig)
    {
        $this->___init();
        parent::__construct($tfa, $tfaSession, $configRequestManager, $tokenManager, $actionFlag, $url, $authorization, $userContext, $adminAdobeImsConfig);
    }
